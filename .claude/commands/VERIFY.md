...
5. Capture la preuve dans `.claude/evidence/<REFERENCE>/verified.md` : ce qui a ete parcouru, ce qui a ete observe, les captures ou les reponses brutes. Une affirmation sans sortie collee n'est pas une preuve.
